        ...
        <div className="fixed inset-0 z-[110] bg-black/60 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-300" onClick={onClose}>
            <div className="relative bg-[#0d1117] w-full max-w-2xl max-h-[90vh] rounded-[2.5rem] border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300" onClick={e => e.stopPropagation()}>
                ...
                <div className="px-6 shrink-0 z-10">
                    <div className="flex bg-[#161b2c]/80 border border-white/10 rounded-2xl p-1.5 shadow-inner">
                        <button 
                                ...
                                questions.length > 0 ? (
                                    questions.map(q => (
                                        <div 
                                            ...
                                            className="bg-[#161b2c]/50 border border-white/10 p-5 rounded-2xl hover:bg-white/5 hover:border-white/10 transition-colors shadow-sm cursor-pointer group"
                                        >
                                            ...
                                            <div className="flex items-center justify-between text-[11px] text-slate-400 font-bold uppercase tracking-wider border-t border-white/10 pt-3">
                                ...
                                answers.length > 0 ? (
                                    answers.map(a => (
                                        <div 
                                            ...
                                            className="bg-[#161b2c]/50 border border-white/10 p-5 rounded-2xl hover:bg-white/5 hover:border-white/10 transition-colors shadow-sm cursor-pointer group"
                                        >
                                            <div className="bg-[#0a0f1d] rounded-xl p-3 mb-4 border border-white/10 flex flex-col gap-2 relative overflow-hidden group-hover:border-blue-500/30 transition-colors">
                                            ...
                                            <div className="flex items-center justify-end text-[11px] text-slate-400 font-bold uppercase tracking-wider border-t border-white/10 pt-3">
                ...
                <div className="p-5 border-t border-white/10 bg-[#0a0f1d] shrink-0">
